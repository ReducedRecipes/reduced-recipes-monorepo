 ...
 * (ticket 011, which also imports this module) are scheduled to the next
 * future slot, with ±20 minutes of jitter so we don't hammer the platform
 * at exact-minute boundaries that automation heuristics flag.
 *
